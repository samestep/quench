...
fn run(file: PathBuf, args: Vec<String>, opts: Opts) -> anyhow::Result<()> {
    ...
    let options = deno_runtime::worker::WorkerOptions {
        ...
        unstable: false,
        ca_data: None,
        // https://github.com/denoland/deno/blob/v1.10.2/cli/version.rs
        ...
        // https://github.com/denoland/deno/blob/v1.10.2/runtime/examples/hello_runtime.rs#L39
